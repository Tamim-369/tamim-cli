...
const generateRouteTemplate = (name: string, capitalizedModuleName: string) => `
...
const generateInterfaceTemplate = (
  name: string,
  capitalizedModuleName: string,
  fields: IField[]
) => {
...
const generateValidationTemplate = (
  name: string,
  capitalizedModuleName: string,
  fields: IField[]
) => {
